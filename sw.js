const CACHE='sigap-gempa-flores-v17-separate-admin-sync-alert';
const ASSETS=['./','./index.html','./manifest.webmanifest','./logo-manggarai.png','./icons/icon-192.png','./icons/icon-512.png'];
